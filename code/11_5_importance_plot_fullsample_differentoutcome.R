...
write_xlsx(vimpCI, "data\\fullsample_differentoutcome_vimpCI.xlsx")




# prepare data set
new <- read_excel("data\\fullsample_differentoutcome_vimpCI.xlsx")
...
#add direction 
direction_data <- read_excel("data\\effect_direction_fullsample_differentoutcome.xlsx")
...
ggsave(plot = gg, width = 11, height = 11, device = png, dpi = 600, 
       filename = "importance_plot_fullsample_differentoutcome.png", path = "output\\")
